...
function useForm(...args) {
  ...
  const precognitionEndpoint = (0, import_react8.useRef)(parsedArgs.precognitionEndpoint);
  ...
  const validatorRef = (0, import_react8.useRef)(null);
  const [validating, setValidating] = (0, import_react8.useState)(false);
  const [touchedFields, setTouchedFields] = (0, import_react8.useState)([]);
  const [validFields, setValidFields] = (0, import_react8.useState)([]);
  const withAllErrors = (0, import_react8.useRef)(false);
  ...
  const valid = (0, import_react8.useCallback)(
    (field) => validFields.includes(field),
    [validFields]
  );
  const invalid = (0, import_react8.useCallback)((field) => field in errors, [errors]);
  const touched = (0, import_react8.useCallback)(
